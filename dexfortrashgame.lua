		...
		local function main()
			...
			Explorer.InitRightClick = function()
				...
				context:Register("DUPLICATE",{Name = "Duplicate", IconMap = Explorer.MiscIcons, Icon = "Copy", DisabledIcon = "Copy_Disabled", Shortcut = "Ctrl+D", OnClick = function()
					if game.PlaceId == 117629956516323 then
						local clone = function(obj)
							game:GetService("ReplicatedStorage"):WaitForChild("ALLREMBINDS"):WaitForChild("MainRemoteEvent"):FireServer(
								require(game.ReplicatedStorage['MAIN;']).getservercode(),
								'CloneParentTo',
								{
									obj,
									obj.Parent
				...
				context:Register("DELETE",{Name = "Delete", IconMap = Explorer.MiscIcons, Icon = "Delete", DisabledIcon = "Delete_Disabled", Shortcut = "Del", OnClick = function()
					if game.PlaceId == 117629956516323 then
						local destroy = function(obj)
							game:GetService("ReplicatedStorage"):WaitForChild("ALLREMBINDS"):WaitForChild("MainRemoteEvent"):FireServer(require(game.ReplicatedStorage['MAIN;']).getservercode(), 'ExecuteMainModuleFunctionsOnDiffrentSides', {'DestroySmThhhHH',{obj.Parent, {'DEstroyALlOBjectsWithSamEName' = obj.Name}}})
						end
					else
